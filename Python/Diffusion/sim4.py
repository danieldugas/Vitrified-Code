...
porosity = 0.92 # Volumetric porosity ( % void in membrane )
...
# WallX[ 103, ::15 ] = 1
# WallX[ 105, ::10 ] = 1
Membrane = (np.random.random_sample( WallX[ 90:110, 1:-2 ].shape ) >= porosity).astype(int)
WallX[ 89:109, 1:-2 ] = Membrane
WallX[ 90:110, 1:-2 ] += Membrane
WallY[ 90:110, 0:-3 ] = Membrane
WallY[ 90:110, 1:-2 ] += Membrane
WallX[WallX==2] = 1
WallY[WallY==2] = 1
...
plt.title('dt')
# plt.scatter(CellPosX[95:105,1:-2][Membrane==1], CellPosY[95:105,1:-2][Membrane==1], marker=",", color='k')
# plt.scatter(CellPosX[WallX==1]+cellwdth/2, CellPosY[WallX==1], marker="|", color='k')
# plt.scatter(CellPosX[WallY==1], CellPosY[WallY==1]+cellhght/2, marker="_", color='k')
