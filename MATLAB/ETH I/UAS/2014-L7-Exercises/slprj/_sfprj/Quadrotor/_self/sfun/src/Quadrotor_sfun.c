  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "dbBnNGQXqBjLFNNn2iiDOF") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "wF7duHNUVl1Fae67iePOgH") == 0) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "C2epkpmutzqs43WWOF7HHC") == 0) {
     ...
     case 4:
      {
        if (strcmp(tpChksum, "Vr98gvSLHvPm6PbvYfnxiF") == 0) {
     ...
     case 5:
      {
        if (strcmp(tpChksum, "nSHhAYv19WW5vzZfj7fyp") == 0) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "ltjQL10MvtZKXkOvqCN0dG") == 0) {
