...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1286633535U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3989575784U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3507644488U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2000383702U);
}
...
mxArray *sf_c2_Quadrotor_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0rnosSGG5uuqKZCA81ybuD");
...
static void mdlSetWorkWidths_c2_Quadrotor(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3589249590U));
  ssSetChecksum1(S,(235629654U));
  ssSetChecksum2(S,(2534169336U));
  ssSetChecksum3(S,(2348280273U));
