...
static const char * c1_debug_family_names[8] = { "phi", "theta", "Jr", "nargin",
  "nargout", "omega", "attitude", "attitudeDot" };
...
static void sf_gateway_c1_Quadrotor(SFc1_QuadrotorInstanceStruct *chartInstance);
...
static void c1_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_attitudeDot, const char_T *c1_identifier, real_T c1_y[3]);
static void c1_b_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
...
static void c1_inv3x3(SFc1_QuadrotorInstanceStruct *chartInstance, real_T c1_x[9],
                      real_T c1_y[9]);
static real_T c1_norm(SFc1_QuadrotorInstanceStruct *chartInstance, real_T c1_x[9]);
...
static void c1_b_eml_warning(SFc1_QuadrotorInstanceStruct *chartInstance, char_T
  c1_varargin_2[14]);
static void c1_eml_scalar_eg(SFc1_QuadrotorInstanceStruct *chartInstance);
static void c1_eml_xgemm(SFc1_QuadrotorInstanceStruct *chartInstance, real_T
  c1_A[9], real_T c1_B[3], real_T c1_C[3], real_T c1_b_C[3]);
static void c1_e_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_sprintf, const char_T *c1_identifier, char_T c1_y[14]);
static void c1_f_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, char_T c1_y[14]);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_Quadrotor, const char_T *c1_identifier);
static uint8_T c1_i_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_eml_xgemm(SFc1_QuadrotorInstanceStruct *chartInstance, real_T
  ...
  *chartInstance)
{
  ...
  real_T (*c1_attitudeDot)[3];
  c1_attitudeDot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellmatrix(2, 1), false);
  for (c1_i0 = 0; c1_i0 < 3; c1_i0++) {
    c1_u[c1_i0] = (*c1_attitudeDot)[c1_i0];
  }

  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_Quadrotor;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  for (c1_i1 = 0; c1_i1 < 3; c1_i1++) {
    (*c1_attitudeDot)[c1_i1] = c1_dv0[c1_i1];
  }

  chartInstance->c1_is_active_c1_Quadrotor = c1_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_Quadrotor");
  sf_mex_destroy(&c1_u);
...
static void sf_gateway_c1_Quadrotor(SFc1_QuadrotorInstanceStruct *chartInstance)
{
  ...
  int32_T c1_i4;
  real_T (*c1_attitudeDot)[3];
  real_T (*c1_attitude)[3];
  real_T (*c1_omega)[3];
  c1_attitudeDot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_attitude = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i3 = 0; c1_i3 < 3; c1_i3++) {
    _SFD_DATA_RANGE_CHECK((*c1_attitude)[c1_i3], 1U);
  }
  ...
  for (c1_i4 = 0; c1_i4 < 3; c1_i4++) {
    _SFD_DATA_RANGE_CHECK((*c1_attitudeDot)[c1_i4], 2U);
  }
}
  ...
  *chartInstance)
{
  ...
  real_T c1_dv4[3];
  int32_T c1_i20;
  real_T (*c1_b_attitudeDot)[3];
  real_T (*c1_b_attitude)[3];
  real_T (*c1_b_omega)[3];
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  boolean_T guard3 = false;
  c1_b_attitudeDot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_attitude = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i6 = 0; c1_i6 < 3; c1_i6++) {
    c1_attitude[c1_i6] = (*c1_b_attitude)[c1_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c1_debug_family_names,
    c1_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_phi, 0U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_theta, 1U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_Jr, 2U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 4U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_omega, 5U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_attitude, 6U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_attitudeDot, 7U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 3);
  c1_phi = c1_attitude[0];
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 4);
  c1_theta = c1_attitude[1];
  ...
  c1_Jr[1] = 0.0;
  c1_Jr[4] = c1_d_x;
  c1_Jr[7] = c1_f_x * c1_h_x;
  c1_Jr[2] = 0.0;
  c1_Jr[5] = -c1_j_x;
  c1_Jr[8] = c1_l_x * c1_n_x;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 10);
  for (c1_i7 = 0; c1_i7 < 9; c1_i7++) {
    c1_a[c1_i7] = c1_Jr[c1_i7];
  }
  ...
  if (c1_n1x == 0.0) {
    ...
    c1_o_x = c1_rc;
    c1_b = muDoubleScalarIsNaN(c1_o_x);
    guard3 = false;
    if (c1_b) {
      guard3 = true;
    } else {
      ...
      c1_e_emlrt_marshallIn(chartInstance, sf_mex_call_debug
        ...
        sf_mex_call_debug(sfGlobalDebugInstanceStruct, "sprintf", 1U, 3U, 14,
                          c1_y, 14, c1_b_y, 14, c1_c_y), 14, c1_d_y), "sprintf",
                            c1_str);
      for (c1_i12 = 0; c1_i12 < 14; c1_i12++) {
        c1_b_str[c1_i12] = c1_str[c1_i12];
      }
  ...
  for (c1_i13 = 0; c1_i13 < 3; c1_i13++) {
    c1_b_b[c1_i13] = c1_omega[c1_i13];
  }

  c1_eml_scalar_eg(chartInstance);
  c1_eml_scalar_eg(chartInstance);
  for (c1_i14 = 0; c1_i14 < 3; c1_i14++) {
    c1_attitudeDot[c1_i14] = 0.0;
  }

  for (c1_i15 = 0; c1_i15 < 3; c1_i15++) {
    c1_attitudeDot[c1_i15] = 0.0;
  }

  for (c1_i16 = 0; c1_i16 < 9; c1_i16++) {
    c1_dv1[c1_i16] = c1_c[c1_i16];
  }

  for (c1_i17 = 0; c1_i17 < 3; c1_i17++) {
    c1_dv2[c1_i17] = c1_b_b[c1_i17];
  }

  for (c1_i18 = 0; c1_i18 < 9; c1_i18++) {
    c1_dv3[c1_i18] = c1_dv1[c1_i18];
  }

  for (c1_i19 = 0; c1_i19 < 3; c1_i19++) {
    c1_dv4[c1_i19] = c1_dv2[c1_i19];
  }

  c1_b_eml_xgemm(chartInstance, c1_dv3, c1_dv4, c1_attitudeDot);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -10);
  _SFD_SYMBOL_SCOPE_POP();
  for (c1_i20 = 0; c1_i20 < 3; c1_i20++) {
    (*c1_b_attitudeDot)[c1_i20] = c1_attitudeDot[c1_i20];
  }
  ...
  const mxArray *c1_attitudeDot, const char_T *c1_identifier, real_T c1_y[3])
{
  ...
  c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_attitudeDot), &c1_thisId,
                        c1_y);
  sf_mex_destroy(&c1_attitudeDot);
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_QuadrotorInstanceStruct *chartInstance;
  chartInstance = (SFc1_QuadrotorInstanceStruct *)chartInstanceVoid;
  c1_attitudeDot = sf_mex_dup(c1_mxArrayInData);
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_QuadrotorInstanceStruct *chartInstance;
  chartInstance = (SFc1_QuadrotorInstanceStruct *)chartInstanceVoid;
  c1_Jr = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_Jr), &c1_thisId, c1_y);
  sf_mex_destroy(&c1_Jr);
  c1_i32 = 0;
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mpower"), "name", "name", 4);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 6);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("ismatrix"), "name", "name", 6);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m!matrix_to_integer_power"),
                  "context", "context", 10);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("inv"), "name", "name", 10);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!inv3x3"), "context",
                  "context", 12);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("abs"), "name", "name", 12);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!inv3x3"), "context",
                  "context", 15);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 15);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
...
static void c1_eml_warning(SFc1_QuadrotorInstanceStruct *chartInstance)
{
  ...
  const mxArray *c1_y = NULL;
  (void)chartInstance;
  for (c1_i35 = 0; c1_i35 < 27; c1_i35++) {
    c1_u[c1_i35] = c1_varargin_1[c1_i35];
  }
  ...
  c1_varargin_2[14])
{
  ...
  const mxArray *c1_b_y = NULL;
  (void)chartInstance;
  for (c1_i36 = 0; c1_i36 < 33; c1_i36++) {
    c1_u[c1_i36] = c1_varargin_1[c1_i36];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 10, 0U, 1U, 0U, 2, 1, 33), false);
  for (c1_i37 = 0; c1_i37 < 14; c1_i37++) {
    c1_b_u[c1_i37] = c1_varargin_2[c1_i37];
  }
  ...
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, char_T c1_y[14])
{
  ...
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_cv1, 1, 10, 0U, 1, 0U, 2, 1,
                14);
  for (c1_i41 = 0; c1_i41 < 14; c1_i41++) {
    c1_y[c1_i41] = c1_cv1[c1_i41];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(241354422U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2579406826U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1897267782U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(781383137U);
}
...
mxArray *sf_c1_Quadrotor_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("TepqW5uIey0FEk3lRf7ukG");
...
mxArray *sf_c1_Quadrotor_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Quadrotor_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Quadrotor(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attitudeDot\",},{M[8],M[0],T\"is_active_c1_Quadrotor\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_QuadrotorInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"attitudeDot");
...

        {
          ...
          real_T (*c1_attitude)[3];
          real_T (*c1_attitudeDot)[3];
          c1_attitudeDot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S,
            1);
          c1_attitude = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
          c1_omega = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c1_omega);
          _SFD_SET_DATA_VALUE_PTR(1U, *c1_attitude);
          _SFD_SET_DATA_VALUE_PTR(2U, *c1_attitudeDot);
        }
      }
    } else {
...
{
  sf_gateway_c1_Quadrotor((SFc1_QuadrotorInstanceStruct*) chartInstanceVar);
}
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Quadrotor();/* state var info */
...
static void mdlSetWorkWidths_c1_Quadrotor(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1176487823U));
  ssSetChecksum1(S,(510283151U));
  ssSetChecksum2(S,(2114472264U));
  ssSetChecksum3(S,(1601601219U));
...
static void mdlStart_c1_Quadrotor(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_QuadrotorInstanceStruct *)utMalloc(sizeof
