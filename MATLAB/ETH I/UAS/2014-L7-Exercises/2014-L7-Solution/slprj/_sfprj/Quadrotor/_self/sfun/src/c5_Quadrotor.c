...
static const char * c5_debug_family_names[9] = { "nargin", "nargout",
  "MotorSpeeds", "CThrust", "CDrag", "L", "Moments", "Forces", "Drag" };

/* Function Declarations */
static void initialize_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance);
static void initialize_params_c5_Quadrotor(SFc5_QuadrotorInstanceStruct
  *chartInstance);
static void enable_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance);
static void disable_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Quadrotor(SFc5_QuadrotorInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_Quadrotor(SFc5_QuadrotorInstanceStruct
  *chartInstance);
static void set_sim_state_c5_Quadrotor(SFc5_QuadrotorInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance);
static void sf_gateway_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance);
static void initSimStructsc5_Quadrotor(SFc5_QuadrotorInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_Drag, const char_T *c5_identifier, real_T c5_y[4]);
static void c5_b_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4]);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_c_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_Forces, const char_T *c5_identifier, real_T c5_y[3]);
static void c5_d_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[3]);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_e_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
...
static void c5_power(SFc5_QuadrotorInstanceStruct *chartInstance, real_T c5_a[4],
                     real_T c5_y[4]);
static void c5_eml_scalar_eg(SFc5_QuadrotorInstanceStruct *chartInstance);
static real_T c5_b_power(SFc5_QuadrotorInstanceStruct *chartInstance, real_T
  c5_a);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_f_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_g_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_Quadrotor, const char_T *c5_identifier);
static uint8_T c5_h_emlrt_marshallIn(SFc5_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_QuadrotorInstanceStruct *chartInstance);
...
static void initialize_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Quadrotor = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c5_Forces)[3];
  real_T (*c5_Drag)[4];
  c5_Drag = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 3);
  c5_Forces = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c5_Moments = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_st = NULL;
  c5_st = NULL;
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_createcellmatrix(4, 1), false);
  for (c5_i0 = 0; c5_i0 < 4; c5_i0++) {
    c5_u[c5_i0] = (*c5_Drag)[c5_i0];
  }
  ...
  for (c5_i2 = 0; c5_i2 < 3; c5_i2++) {
    c5_c_u[c5_i2] = (*c5_Moments)[c5_i2];
  }

  c5_d_y = NULL;
  sf_mex_assign(&c5_d_y, sf_mex_create("y", c5_c_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c5_y, 2, c5_d_y);
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_Quadrotor;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)), "Drag",
                      c5_dv0);
  for (c5_i3 = 0; c5_i3 < 4; c5_i3++) {
    (*c5_Drag)[c5_i3] = c5_dv0[c5_i3];
  }

  c5_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
                        "Forces", c5_dv1);
  for (c5_i4 = 0; c5_i4 < 3; c5_i4++) {
    (*c5_Forces)[c5_i4] = c5_dv1[c5_i4];
  }

  c5_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
                        "Moments", c5_dv2);
  for (c5_i5 = 0; c5_i5 < 3; c5_i5++) {
    (*c5_Moments)[c5_i5] = c5_dv2[c5_i5];
  }

  chartInstance->c5_is_active_c5_Quadrotor = c5_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 3)), "is_active_c5_Quadrotor");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_Quadrotor(chartInstance);
...
static void sf_gateway_c5_Quadrotor(SFc5_QuadrotorInstanceStruct *chartInstance)
{
  ...
  real_T c5_a;
  int32_T c5_i8;
  real_T c5_b_MotorSpeeds[4];
  real_T c5_b[4];
  int32_T c5_i9;
  real_T c5_b_a;
  int32_T c5_i10;
  real_T c5_c_MotorSpeeds[4];
  int32_T c5_i11;
  real_T c5_y;
  int32_T c5_k;
  int32_T c5_b_k;
  ...
  real_T *c5_b_CDrag;
  real_T *c5_b_L;
  real_T (*c5_b_Moments)[3];
  real_T (*c5_b_Forces)[3];
  real_T (*c5_b_Drag)[4];
  real_T (*c5_d_MotorSpeeds)[4];
  c5_b_Drag = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 3);
  c5_b_L = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c5_b_CDrag = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c5_b_CThrust = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c5_b_Forces = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c5_b_Moments = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_d_MotorSpeeds = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i6 = 0; c5_i6 < 4; c5_i6++) {
    _SFD_DATA_RANGE_CHECK((*c5_d_MotorSpeeds)[c5_i6], 0U);
  }

  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  c5_hoistedGlobal = *c5_b_CThrust;
  c5_b_hoistedGlobal = *c5_b_CDrag;
  c5_c_hoistedGlobal = *c5_b_L;
  for (c5_i7 = 0; c5_i7 < 4; c5_i7++) {
    c5_MotorSpeeds[c5_i7] = (*c5_d_MotorSpeeds)[c5_i7];
  }

  c5_CThrust = c5_hoistedGlobal;
  c5_CDrag = c5_b_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_MotorSpeeds, 2U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_CThrust, 3U, c5_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_CDrag, 4U, c5_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_L, 5U, c5_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_Moments, 6U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_Forces, 7U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_Drag, 8U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 3);
  c5_a = c5_CDrag;
  for (c5_i8 = 0; c5_i8 < 4; c5_i8++) {
    c5_b_MotorSpeeds[c5_i8] = c5_MotorSpeeds[c5_i8];
  }

  c5_power(chartInstance, c5_b_MotorSpeeds, c5_b);
  for (c5_i9 = 0; c5_i9 < 4; c5_i9++) {
    c5_Drag[c5_i9] = c5_a * c5_b[c5_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 4);
  c5_b_a = c5_CThrust;
  for (c5_i10 = 0; c5_i10 < 4; c5_i10++) {
    c5_c_MotorSpeeds[c5_i10] = c5_MotorSpeeds[c5_i10];
  }

  c5_power(chartInstance, c5_c_MotorSpeeds, c5_b);
  for (c5_i11 = 0; c5_i11 < 4; c5_i11++) {
    c5_b[c5_i11] *= c5_b_a;
  }

  c5_y = c5_b[0];
  for (c5_k = 2; c5_k < 5; c5_k++) {
    c5_b_k = c5_k;
    c5_y += c5_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
  ...
  c5_d0 = c5_b_power(chartInstance, c5_MotorSpeeds[3]);
  c5_d1 = c5_b_power(chartInstance, c5_MotorSpeeds[1]);
  c5_d2 = c5_b_power(chartInstance, c5_MotorSpeeds[0]);
  c5_d3 = c5_b_power(chartInstance, c5_MotorSpeeds[2]);
  c5_Moments[0] = c5_L * c5_CThrust * (c5_d0 - c5_d1);
  c5_Moments[1] = c5_L * c5_CThrust * (c5_d2 - c5_d3);
  c5_Moments[2] = ((c5_Drag[0] - c5_Drag[1]) + c5_Drag[2]) - c5_Drag[3];
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  for (c5_i12 = 0; c5_i12 < 3; c5_i12++) {
    (*c5_b_Moments)[c5_i12] = c5_Moments[c5_i12];
  }

  for (c5_i13 = 0; c5_i13 < 3; c5_i13++) {
    (*c5_b_Forces)[c5_i13] = c5_Forces[c5_i13];
  }

  for (c5_i14 = 0; c5_i14 < 4; c5_i14++) {
    (*c5_b_Drag)[c5_i14] = c5_Drag[c5_i14];
  }
  ...
  for (c5_i15 = 0; c5_i15 < 3; c5_i15++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_Moments)[c5_i15], 1U);
  }

  for (c5_i16 = 0; c5_i16 < 3; c5_i16++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_Forces)[c5_i16], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c5_b_CThrust, 3U);
  _SFD_DATA_RANGE_CHECK(*c5_b_CDrag, 4U);
  _SFD_DATA_RANGE_CHECK(*c5_b_L, 5U);
  for (c5_i17 = 0; c5_i17 < 4; c5_i17++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_Drag)[c5_i17], 6U);
  }
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u[4];
  const mxArray *c5_y = NULL;
  SFc5_QuadrotorInstanceStruct *chartInstance;
  chartInstance = (SFc5_QuadrotorInstanceStruct *)chartInstanceVoid;
  c5_mxArrayOutData = NULL;
  for (c5_i18 = 0; c5_i18 < 4; c5_i18++) {
    c5_b_inData[c5_i18] = (*(real_T (*)[4])c5_inData)[c5_i18];
  }
  ...
  const mxArray *c5_Drag, const char_T *c5_identifier, real_T c5_y[4])
{
  ...
  c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_Drag), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_Drag);
}
  ...
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4])
{
  ...
  int32_T c5_i20;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv3, 1, 0, 0U, 1, 0U, 1, 4);
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_QuadrotorInstanceStruct *chartInstance;
  chartInstance = (SFc5_QuadrotorInstanceStruct *)chartInstanceVoid;
  c5_Drag = sf_mex_dup(c5_mxArrayInData);
  ...
  for (c5_i21 = 0; c5_i21 < 4; c5_i21++) {
    (*(real_T (*)[4])c5_outData)[c5_i21] = c5_y[c5_i21];
  }
  ...
  const mxArray *c5_Forces, const char_T *c5_identifier, real_T c5_y[3])
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_Forces), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_Forces);
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_QuadrotorInstanceStruct *chartInstance;
  chartInstance = (SFc5_QuadrotorInstanceStruct *)chartInstanceVoid;
  c5_Forces = sf_mex_dup(c5_mxArrayInData);
  c5_identifier = c5_varName;
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_Forces), &c5_thisId, c5_y);
...
const mxArray *sf_c5_Quadrotor_get_eml_resolved_functions_info(void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 23, 1),
                false);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("power"), "name", "name", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("floor"), "name", "name", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sum"), "name", "name", 12);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m"), "context",
                  "context", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("isequal"), "name", "name", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 21);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmax"), "name", "name", 21);
  ...
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId)
{
  ...
  int32_T c5_i26;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), &c5_i26, 1, 6, 0U, 0, 0U, 0);
  c5_y = c5_i26;
  sf_mex_destroy(&c5_u);
  return c5_y;
}
  ...
  const mxArray *c5_b_is_active_c5_Quadrotor, const char_T *c5_identifier)
{
  ...
  c5_y = c5_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Quadrotor), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Quadrotor);
  return c5_y;
}
...
void sf_c5_Quadrotor_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2654191549U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2071455760U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4031625201U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1482856138U);
}

mxArray *sf_c5_Quadrotor_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("PNWupBJJ6lmyUBKC1kgs5B");
...
mxArray *sf_c5_Quadrotor_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_Quadrotor_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_Quadrotor(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[10],T\"Drag\",},{M[1],M[6],T\"Forces\",},{M[1],M[5],T\"Moments\",},{M[8],M[0],T\"is_active_c5_Quadrotor\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Quadrotor_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_QuadrotorInstanceStruct *) chartInfo->chartInstance;
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"MotorSpeeds");
          _SFD_SET_DATA_PROPS(1,2,0,1,"Moments");
          _SFD_SET_DATA_PROPS(2,2,0,1,"Forces");
          _SFD_SET_DATA_PROPS(3,1,1,0,"CThrust");
          _SFD_SET_DATA_PROPS(4,1,1,0,"CDrag");
          _SFD_SET_DATA_PROPS(5,1,1,0,"L");
          _SFD_SET_DATA_PROPS(6,2,0,1,"Drag");
...

        {
          ...
          real_T (*c5_Drag)[4];
          c5_Drag = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 3);
          c5_L = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c5_CDrag = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c5_CThrust = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c5_Forces = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
          c5_Moments = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c5_MotorSpeeds = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S,
            0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c5_MotorSpeeds);
          _SFD_SET_DATA_VALUE_PTR(1U, *c5_Moments);
          _SFD_SET_DATA_VALUE_PTR(2U, *c5_Forces);
          _SFD_SET_DATA_VALUE_PTR(3U, c5_CThrust);
          _SFD_SET_DATA_VALUE_PTR(4U, c5_CDrag);
          _SFD_SET_DATA_VALUE_PTR(5U, c5_L);
          _SFD_SET_DATA_VALUE_PTR(6U, *c5_Drag);
        }
      }
    } else {
...
{
  return "mC6tzr9Bqg5sqWVa6iJBmE";
}

static void sf_opaque_initialize_c5_Quadrotor(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_QuadrotorInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*)
    chartInstanceVar);
  initialize_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_Quadrotor(void *chartInstanceVar)
{
  enable_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_Quadrotor(void *chartInstanceVar)
{
  disable_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_Quadrotor(void *chartInstanceVar)
{
  sf_gateway_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_Quadrotor(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_Quadrotor();/* state var info */
...
extern void sf_internal_set_sim_state_c5_Quadrotor(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_Quadrotor();/* state var info */
  ...
  set_sim_state_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_Quadrotor(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_Quadrotor(S);
}

static void sf_opaque_set_sim_state_c5_Quadrotor(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Quadrotor(S, st);
}

static void sf_opaque_terminate_c5_Quadrotor(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_QuadrotorInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_Quadrotor((SFc5_QuadrotorInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_Quadrotor((SFc5_QuadrotorInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Quadrotor(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Quadrotor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3696704749U));
  ssSetChecksum1(S,(426199084U));
  ssSetChecksum2(S,(91943087U));
  ssSetChecksum3(S,(3133757957U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_Quadrotor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Quadrotor(SimStruct *S)
{
  SFc5_QuadrotorInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_QuadrotorInstanceStruct *)utMalloc(sizeof
    (SFc5_QuadrotorInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_QuadrotorInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_Quadrotor;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_Quadrotor;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_Quadrotor;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_Quadrotor;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_Quadrotor;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_Quadrotor;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_Quadrotor;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_Quadrotor;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_Quadrotor;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_Quadrotor;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Quadrotor;
...
void c5_Quadrotor_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Quadrotor(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Quadrotor(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Quadrotor(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Quadrotor_method_dispatcher.\n"
