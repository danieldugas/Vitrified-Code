...
static const char * c1_debug_family_names[8] = { "phi", "theta", "Jinv",
  "nargin", "nargout", "omega", "attitude", "attitudeDot" };
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_Quadrotor, const char_T *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_QuadrotorInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_Quadrotor = c1_f_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c1_Quadrotor(SFc1_QuadrotorInstanceStruct *chartInstance)
{
  ...
  for (c1_i2 = 0; c1_i2 < 3; c1_i2++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_omega)[c1_i2], 0U);
  }

  for (c1_i3 = 0; c1_i3 < 3; c1_i3++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_attitude)[c1_i3], 1U);
  }
  ...
  for (c1_i5 = 0; c1_i5 < 3; c1_i5++) {
    c1_attitude[c1_i5] = (*c1_b_attitude)[c1_i5];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_theta, 1U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_Jinv, 2U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  ...
  c1_c_x = c1_theta;
  c1_d_x = c1_c_x;
  c1_d_x = muDoubleScalarTan(c1_d_x);
  c1_e_x = c1_phi;
  c1_f_x = c1_e_x;
  c1_f_x = muDoubleScalarCos(c1_f_x);
  c1_g_x = c1_theta;
  c1_h_x = c1_g_x;
  c1_h_x = muDoubleScalarTan(c1_h_x);
  c1_i_x = c1_phi;
  c1_j_x = c1_i_x;
  ...
  c1_ab_x = c1_y_x;
  c1_g_y = c1_f_y;
  c1_h_y = c1_ab_x / c1_g_y;
  c1_Jinv[0] = 1.0;
  c1_Jinv[3] = c1_b_x * c1_d_x;
  c1_Jinv[6] = c1_f_x * c1_h_x;
  c1_Jinv[1] = 0.0;
  c1_Jinv[4] = c1_j_x;
  c1_Jinv[7] = -c1_l_x;
  c1_Jinv[2] = 0.0;
  ...
  for (c1_i6 = 0; c1_i6 < 9; c1_i6++) {
    c1_a[c1_i6] = c1_Jinv[c1_i6];
  }

  for (c1_i7 = 0; c1_i7 < 3; c1_i7++) {
    c1_b[c1_i7] = c1_omega[c1_i7];
  }

  c1_eml_scalar_eg(chartInstance);
  c1_eml_scalar_eg(chartInstance);
  for (c1_i8 = 0; c1_i8 < 3; c1_i8++) {
    c1_attitudeDot[c1_i8] = 0.0;
  }

  for (c1_i9 = 0; c1_i9 < 3; c1_i9++) {
    c1_attitudeDot[c1_i9] = 0.0;
  }

  for (c1_i10 = 0; c1_i10 < 9; c1_i10++) {
    c1_dv1[c1_i10] = c1_a[c1_i10];
  }

  for (c1_i11 = 0; c1_i11 < 3; c1_i11++) {
    c1_dv2[c1_i11] = c1_b[c1_i11];
  }

  for (c1_i12 = 0; c1_i12 < 9; c1_i12++) {
    c1_dv3[c1_i12] = c1_dv1[c1_i12];
  }

  for (c1_i13 = 0; c1_i13 < 3; c1_i13++) {
    c1_dv4[c1_i13] = c1_dv2[c1_i13];
  }
  ...
  for (c1_i14 = 0; c1_i14 < 3; c1_i14++) {
    (*c1_b_attitudeDot)[c1_i14] = c1_attitudeDot[c1_i14];
  }
  ...
  for (c1_i15 = 0; c1_i15 < 3; c1_i15++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_attitudeDot)[c1_i15], 2U);
  }
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_QuadrotorInstanceStruct *chartInstance;
  chartInstance = (SFc1_QuadrotorInstanceStruct *)chartInstanceVoid;
  c1_Jinv = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_Jinv), &c1_thisId, c1_y);
  sf_mex_destroy(&c1_Jinv);
  c1_i27 = 0;
  for (c1_i28 = 0; c1_i28 < 3; c1_i28++) {
    for (c1_i29 = 0; c1_i29 < 3; c1_i29++) {
      (*(real_T (*)[9])c1_outData)[c1_i29 + c1_i27] = c1_y[c1_i29 + c1_i27];
    }
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("tan"), "name", "name", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  c1_A[9], real_T c1_B[3], real_T c1_C[3], real_T c1_b_C[3])
{
  ...
  for (c1_i30 = 0; c1_i30 < 3; c1_i30++) {
    c1_b_C[c1_i30] = c1_C[c1_i30];
  }

  for (c1_i31 = 0; c1_i31 < 9; c1_i31++) {
    c1_b_A[c1_i31] = c1_A[c1_i31];
  }

  for (c1_i32 = 0; c1_i32 < 3; c1_i32++) {
    c1_b_B[c1_i32] = c1_B[c1_i32];
  }
  ...
  c1_A[9], real_T c1_B[3], real_T c1_C[3])
{
  ...
  for (c1_i34 = 0; c1_i34 < 3; c1_i34++) {
    ...
    for (c1_i36 = 0; c1_i36 < 3; c1_i36++) {
      c1_C[c1_i34] += c1_A[c1_i35 + c1_i34] * c1_B[c1_i36];
      c1_i35 += 3;
    }
  }
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3790860356U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(872340078U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(657122473U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2652357063U);
}
...
mxArray *sf_c1_Quadrotor_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("w3LFBkHopH3omVb4lXjVDE");
...
static void mdlSetWorkWidths_c1_Quadrotor(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(489528155U));
  ssSetChecksum1(S,(3783661128U));
  ssSetChecksum2(S,(3233921744U));
  ssSetChecksum3(S,(3516626363U));
