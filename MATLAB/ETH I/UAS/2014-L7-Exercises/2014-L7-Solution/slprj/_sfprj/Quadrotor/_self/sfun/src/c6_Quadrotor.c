...
static const char * c6_debug_family_names[11] = { "Uind", "i", "nargin",
...
static void sf_gateway_c6_Quadrotor(SFc6_QuadrotorInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 3U, c6_b_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_InputVoltage, 4U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_Drag, 5U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_KMotor, 6U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_IMotor, 7U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_RMotor, 8U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_MotorSpeeds, 9U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_MotorSpeedsDer, 10U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4183929580U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2702160687U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(387184996U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2033160069U);
}
...
mxArray *sf_c6_Quadrotor_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Ra7u0UzGB9cykVQSCAjjrB");
...
static void mdlSetWorkWidths_c6_Quadrotor(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(881190714U));
  ssSetChecksum1(S,(3756810444U));
  ssSetChecksum2(S,(2679065186U));
  ssSetChecksum3(S,(344291276U));
