...
static void c1_set_sim_state_side_effects_c1_newtons_cradle
  (SFc1_newtons_cradleInstanceStruct *chartInstance);
...
static const mxArray *c1_emlrt_marshallOut(SFc1_newtons_cradleInstanceStruct
  *chartInstance);
static const mxArray *c1_b_emlrt_marshallOut(SFc1_newtons_cradleInstanceStruct
  *chartInstance, real_T c1_u[3]);
static const mxArray *c1_c_emlrt_marshallOut(SFc1_newtons_cradleInstanceStruct
  *chartInstance, uint8_T c1_u);
static void c1_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct *chartInstance,
  const mxArray *c1_u);
static void c1_b_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct
...
static void c1_c_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[3]);
static uint8_T c1_d_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_newtons_cradle, const char_T *
  c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *c1_f_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_g_emlrt_marshallIn(SFc1_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1973746383U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1071654861U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1376671190U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(448618149U);
}
...
static const mxArray *sf_get_sim_state_info_c1_newtons_cradle(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[25],T\"p_out\",},{M[1],M[26],T\"v_out\",},{M[5],M[30],T\"p\",},{M[5],M[31],T\"v\",},{M[8],M[0],T\"is_active_c1_newtons_cradle\",},{M[9],M[0],T\"is_c1_newtons_cradle\",}}"
  };
...
static void sf_opaque_zeroCrossings_c1_newtons_cradle(void *chartInstanceVar)
{
  zeroCrossings_c1_newtons_cradle((SFc1_newtons_cradleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_outputs_c1_newtons_cradle(void *chartInstanceVar)
{
  outputs_c1_newtons_cradle((SFc1_newtons_cradleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_derivatives_c1_newtons_cradle(void *chartInstanceVar)
{
  derivatives_c1_newtons_cradle((SFc1_newtons_cradleInstanceStruct*)
    chartInstanceVar);
}
...
static void mdlSetWorkWidths_c1_newtons_cradle(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2728007547U));
  ssSetChecksum1(S,(110146653U));
  ssSetChecksum2(S,(2941306383U));
  ssSetChecksum3(S,(2934101780U));
...
static void mdlStart_c1_newtons_cradle(SimStruct *S)
{
  ...
  chartInstance->chartInfo.zeroCrossings =
    sf_opaque_zeroCrossings_c1_newtons_cradle;
  chartInstance->chartInfo.outputs = sf_opaque_outputs_c1_newtons_cradle;
  chartInstance->chartInfo.derivatives = sf_opaque_derivatives_c1_newtons_cradle;
