...
#define c1_IN_Filling_Tank_1           ((uint8_T)1U)
#define c1_IN_Filling_Tank_2           ((uint8_T)2U)
...
static const mxArray *c1_d_emlrt_marshallOut(SFc1_two_tanksInstanceStruct
  *chartInstance, uint8_T c1_u);
static void c1_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_u);
static real_T c1_b_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_q, const char_T *c1_identifier);
static real_T c1_c_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_x_out, const char_T *c1_identifier, real_T c1_y[2]);
static void c1_e_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[2]);
static uint8_T c1_f_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_two_tanks, const char_T *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_two_tanksInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *c1_h_emlrt_marshallIn(SFc1_two_tanksInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_i_emlrt_marshallIn(SFc1_two_tanksInstanceStruct
...
static void initialize_c1_two_tanks(SFc1_two_tanksInstanceStruct *chartInstance)
{
  ...
  (*c1_x)[0] = 5.0;
  (*c1_x)[1] = 4.0;
  chartInstance->c1_is_c1_two_tanks = c1_IN_Filling_Tank_1;
}
  ...
  if (ssIsMajorTimeStep(chartInstance->S) != 0) {
    ...
    *c1_q = 0.0;
    switch (chartInstance->c1_is_c1_two_tanks) {
     case c1_IN_Filling_Tank_1:
      if ((*c1_x)[1] < chartInstance->c1_r[1]) {
        c1_stateChanged = TRUE;
        chartInstance->c1_is_c1_two_tanks = c1_IN_Filling_Tank_2;
      }
      break;

     case c1_IN_Filling_Tank_2:
  ...
  *chartInstance)
{
  ...
  sf_mex_setcell(c1_y, 0, c1_b_emlrt_marshallOut(chartInstance, *c1_q));
  for (c1_i4 = 0; c1_i4 < 2; c1_i4++) {
    c1_dv0[c1_i4] = (*c1_x_out)[c1_i4];
  }

  sf_mex_setcell(c1_y, 1, c1_c_emlrt_marshallOut(chartInstance, c1_dv0));
  for (c1_i4 = 0; c1_i4 < 2; c1_i4++) {
    c1_dv0[c1_i4] = (*c1_x)[c1_i4];
  }

  sf_mex_setcell(c1_y, 2, c1_c_emlrt_marshallOut(chartInstance, c1_dv0));
  sf_mex_setcell(c1_y, 3, c1_d_emlrt_marshallOut(chartInstance,
    chartInstance->c1_is_active_c1_two_tanks));
  sf_mex_setcell(c1_y, 4, c1_d_emlrt_marshallOut(chartInstance,
  ...
  const mxArray *c1_u)
{
  ...
  c1_x = (real_T (*)[2])(ssGetContStates(chartInstance->S) + 0);
  c1_x_out = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 1);
  *c1_q = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "q");
  c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
                        "x_out", *c1_x_out);
  c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)), "x",
                        *c1_x);
  chartInstance->c1_is_active_c1_two_tanks = c1_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "is_active_c1_two_tanks");
  chartInstance->c1_is_c1_two_tanks = c1_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 4)), "is_c1_two_tanks");
  ...
  const mxArray *c1_q, const char_T *c1_identifier)
{
  ...
  c1_y = c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_q), &c1_thisId);
  sf_mex_destroy(&c1_q);
  return c1_y;
}
  ...
  const mxArray *c1_x_out, const char_T *c1_identifier, real_T c1_y[2])
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_x_out), &c1_thisId, c1_y);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2541664964U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(199825183U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1133987125U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3205065533U);
}
...
mxArray *sf_c1_two_tanks_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("srotBWR3bvKt5qikBTVTmD");
...
static const mxArray *sf_get_sim_state_info_c1_two_tanks(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[53],T\"q\",},{M[1],M[25],T\"x_out\",},{M[5],M[30],T\"x\",},{M[8],M[0],T\"is_active_c1_two_tanks\",},{M[9],M[0],T\"is_c1_two_tanks\",}}"
  };
...
static void mdlSetWorkWidths_c1_two_tanks(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2045016162U));
  ssSetChecksum1(S,(1779052372U));
  ssSetChecksum2(S,(2739816459U));
  ssSetChecksum3(S,(3774622126U));
