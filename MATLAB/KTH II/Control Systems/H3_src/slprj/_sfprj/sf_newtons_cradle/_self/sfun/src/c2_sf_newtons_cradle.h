...
/* Type Definitions */
#ifndef typedef_SFc2_sf_newtons_cradleInstanceStruct
#define typedef_SFc2_sf_newtons_cradleInstanceStruct
...
#endif                                 /*typedef_SFc2_sf_newtons_cradleInstanceStruct*/
