...
static void sf_c2_sf_newtons_cradle(SFc2_sf_newtons_cradleInstanceStruct
  *chartInstance);
static void initSimStructsc2_sf_newtons_cradle
  (SFc2_sf_newtons_cradleInstanceStruct *chartInstance);
...
static uint8_T c2_b_emlrt_marshallIn(SFc2_sf_newtons_cradleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static const mxArray *c2_c_emlrt_marshallIn(SFc2_sf_newtons_cradleInstanceStruct
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_c2_sf_newtons_cradle = c2_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  if (chartInstance->c2_is_active_c2_sf_newtons_cradle == 0U) {
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sf_newtons_cradle), &c2_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3258789219U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3059423989U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3809372367U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3821570454U);
}
...
mxArray *sf_c2_sf_newtons_cradle_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ck9UibYBBLc71AlgkxEyS");
...
mxArray *sf_c2_sf_newtons_cradle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_sf_newtons_cradle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_sf_newtons_cradle(void)
{
...
extern const mxArray* sf_internal_get_sim_state_c2_sf_newtons_cradle(SimStruct*
  S)
{
...
extern void sf_internal_set_sim_state_c2_sf_newtons_cradle(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
static const mxArray* sf_opaque_get_sim_state_c2_sf_newtons_cradle(SimStruct* S)
{
...
{
  initSimStructsc2_sf_newtons_cradle((SFc2_sf_newtons_cradleInstanceStruct*)
    chartInstanceVar);
}
...
static void mdlSetWorkWidths_c2_sf_newtons_cradle(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(138621136U));
  ssSetChecksum1(S,(2596431285U));
  ssSetChecksum2(S,(2177906124U));
  ssSetChecksum3(S,(2068751896U));
...
{
  SFc2_sf_newtons_cradleInstanceStruct *chartInstance;
  chartInstance = (SFc2_sf_newtons_cradleInstanceStruct *)utMalloc(sizeof
