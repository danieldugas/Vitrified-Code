...
/* Type Definitions */
#ifndef typedef_SFc1_sf_newtons_cradleInstanceStruct
#define typedef_SFc1_sf_newtons_cradleInstanceStruct
...
#endif                                 /*typedef_SFc1_sf_newtons_cradleInstanceStruct*/
